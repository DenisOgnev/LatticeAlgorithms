...
Eigen::Matrix<mp::cpp_rational, -1, -1> mgs(const Eigen::Matrix<mp::cpp_int, -1, -1> &mat)
{
	std::vector<Eigen::Vector<mp::cpp_rational, -1>> basis;
	std::vector<int> indexes;
...
int main()
{
	Eigen::Matrix<boost::multiprecision::cpp_int, -1, -1> mat = Utils::generate_random_matrix_with_full_row_rank(50, 50, 1, 100);
