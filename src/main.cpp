...
int main()
{
	Eigen::Matrix<boost::multiprecision::cpp_int, Eigen::Dynamic, Eigen::Dynamic> mat = Utils::generate_random_matrix_with_full_row_rank(25, 25, 1, 10);
	//mat << 1, 1, -1, 2;
...
//  5,  9,  1,  2,  2,  4;
	...
	Eigen::Matrix<boost::multiprecision::number<boost::multiprecision::cpp_bin_float_100::backend_type, boost::multiprecision::et_off>, 2, 2> mat2;
