...
int main()
{
	Eigen::Matrix<unsigned long long, Eigen::Dynamic, Eigen::Dynamic> mat = Utils::generate_random_matrix_with_full_row_rank(15, 15, 1, 10);
	//mat << 1, 1, -1, 2;
...
//  5,  9,  1,  2,  2,  4;
	...
	// Eigen::Matrix<unsigned long long, Eigen::Dynamic, Eigen::Dynamic> HNF = Algorithms::HNF::HNF_full_row_rank(mat);
