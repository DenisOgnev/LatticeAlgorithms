...
namespace Utils
{
    ...
    std::tuple<Eigen::Matrix<boost::multiprecision::cpp_int, -1, -1>, std::vector<int>> get_linearly_independent_rows_by_gram_schmidt(const Eigen::Matrix<boost::multiprecision::cpp_int, -1, -1> &matrix);
